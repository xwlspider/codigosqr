...
export const s = StyleSheet.create({
  ...
  // ── Misma lógica que Login/Register ───────────────────────────────────────
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#030f0e', borderRadius: 14, borderWidth: 1, borderColor: BORDER, paddingHorizontal: 12 },
  inputIcon: { fontSize: 14, marginRight: 8, color: TEXT },
  networkIcon:  { fontSize: 13, fontWeight: '800', color: TEXT, marginRight: 8 }, // ← color TEXT = blanco
